...
args.dir = args.dir + args.dataset+'/'+args.model + '/Lanczos/lr='+str(args.lr_init)+'_matrix='+args.matrix_type+'_damping='+str(args.lanczos_beta)+'_wd='+str(args.wd)+'_grad_batch_size='+str(args.batch_size)+'_curv_batch_size='+str(args.lanczos_batch)+'/'
...
for epoch in range(start_epoch, args.epochs):
    ...
    if (train_res['accuracy'] < 5) and epoch > 5:
        print('algorithm not learning')
        break
