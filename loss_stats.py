...
print('saving to '+args.ckpt[0][:-val]+str(int(args.ckpt[0][-6:-3]))+'-'+name+'_loss_stats_b='+str(args.num_samples))
...
np.savez(
    args.ckpt[0][:-val]+str(int(args.ckpt[0][-6:-3]))+'-'+name+'_loss_stats_b='+str(args.num_samples),
