...
python3 ../run_padam.py --dataset=ImageNet32 --data_path ../../curvature/data/ --model=WideResNet28x10 --save_freq=30 --use_test --lr_init=0.03 --wd 3e-4 --decoupled_wd --eval_freq=1 --dir ../out/ --epochs 100 --seed 1 --auto --swag_start 30 --no_covariance
