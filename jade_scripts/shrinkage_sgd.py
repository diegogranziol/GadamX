...
args.dir = args.dir + args.dataset + '/' + args.model + '/Shrinkage_SGD' + '/seed='+str(args.seed)+'_lr='+str(args.lr_init)+'_swastart=' +str(args.swag_start) + '_slr=' +str(args.swag_lr) + '_wdfreq='+str(args.wd_freq)+'_matrix='+ args.curvature_matrix + '_wdend=' +str(args.epochend) + '/'
