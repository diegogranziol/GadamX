...
python3 ../run_sgd.py --dataset=ImageNet32 --data_path ../data/ --model=WideResNet28x10 --save_freq=25 --use_test --lr_init=0.05 --wd 0 --eval_freq=1 --dir ../out/ --epochs 100 --seed 1
