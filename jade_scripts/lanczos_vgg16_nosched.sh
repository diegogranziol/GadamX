...
python3 ../run_lanczos.py --dir /jmain01/home/JAD017/sjr01/dxg49-sjr01/kfac-curvature/out  --dataset CIFAR100 --data_path /jmain01/home/JAD017/sjr01/dxg49-sjr01/curvature/data/ --model VGG16 --lr_init 1 --epochs 100 --save_freq=10 --eval_freq=1 --lanczos_steps=20 --matrix_type='gn' --lanczos_beta=10 --no_schedule
