...
from curvature import models, losses, utils
from curvature import data_subset, data
...
args.dir = args.dir  + args.dataset + '/' + args.model + '/SSGDMN'
thing = ""
# if args.no_schedule:
#     thing += "_flat"
...
args.dir += '/seed='+str(args.seed)+'_epoch_freq='+str(args.epochfreq)+'_curvaturesize='+str(args.curvaturebatchsize)+'_warmstart='+str(args.warmstart)+ '_mom=' + str(args.momentum) + '_wd=' + str(
    args.wd) + thing + '_numepochs=' + str(args.epochs) + '_batchsize='+str(args.batch_size)+'/'
...
datasets, num_classes = data_subset.datasets(
    args.dataset,
    args.data_path,
