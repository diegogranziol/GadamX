...
args.dir = args.dir + args.dataset+'/'+args.model+'/Adam'+add+'/seed='+str(args.seed)+'_batch_size='+str(args.batch_size)+'_lr='+str(args.lr_init)+'_wd='+str(args.wd)+'_adam_eps='+str(args.adam_eps)+'_numepochs='+str(args.epochs)+end+'/'
...
def schedule_cos_annealing(epoch):
    """
    ...
    if args.swag and epoch > args.swag_start:
...
for epoch in range(start_epoch, args.epochs):
    ...
    if not args.no_schedule:
        if args.cosine_annealing:
            lr = schedule_cos_annealing(epoch)
        elif args.linear_annealing:
            lr = schedule_variant(epoch)
        else:
            lr = schedule(epoch)
