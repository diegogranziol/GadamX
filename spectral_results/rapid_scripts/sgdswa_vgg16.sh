...
python3 shrinkage_sgd.py --dir out/ --dataset CIFAR100 --wd_freq=25 --stats_batch=256 --data_path data/ --model VGG16BN --lr_init 0.1  --epochs 300 --save_freq=25 --eval_freq=5 --swag  --swag_start=161 --swag_lr=0.1
python3 shrinkage_sgd.py --dir out/ --dataset CIFAR100 --wd_freq=25 --stats_batch=256 --data_path data/ --model VGG16BN --lr_init 0.1  --epochs 300 --save_freq=25 --eval_freq=5 --swag  --swag_start=161 --swag_lr=0.05

python3 shrinkage_sgd.py --dir out/ --dataset CIFAR100 --wd_freq=25 --stats_batch=256 --data_path data/ --model VGG16 --lr_init 0.05 --epochs 300 --save_freq=25 --eval_freq=5 --swag  --swag_start=161 --swag_lr=0.05
python3 shrinkage_sgd.py --dir out/ --dataset CIFAR100 --wd_freq=25 --stats_batch=256 --data_path data/ --model VGG16 --lr_init 0.05 --epochs 300 --save_freq=25 --eval_freq=5 --swag  --swag_start=161 --swag_lr=0.01
